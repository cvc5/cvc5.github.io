...
define("ace/mode/tptp_highlight_rules",
...
define("ace/mode/tptp",
    ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/tptp_highlight_rules",
        "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/tptp"],
    function (require, exports, module) {
    "use strict";

    var oop = require("../lib/oop");
    var TextMode = require("./text").Mode;
    var SmtLibHighlightRules = require("./tptp_highlight_rules").SmtLibHighlightRules;
    var MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
    var CstyleBehaviour = require("./behaviour/cstyle").CstyleBehaviour;
    var CStyleFoldMode = require("./folding/tptp").FoldMode;
